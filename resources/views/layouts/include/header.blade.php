      ...
      <div id="navbarMenu" class="navbar-menu-wrapper">
        ...
        <ul class="nav navbar-menu">
          ...
          <li class="nav-item with-sub">
            <a href="" class="nav-link"><i data-feather="pie-chart"></i> Cruds</a>
            <ul class="navbar-menu-sub">
              <li class="nav-sub-item"><a href="{{ route('user.index') }}" class="nav-sub-link"><i data-feather="bar-chart-2"></i>User Table</a></li>
              <li class="nav-sub-item"><a href="{{ route('category.index') }}" class="nav-sub-link"><i data-feather="bar-chart-2"></i>Category Table</a></li>
              <li class="nav-sub-item"><a href="{{ route('priority.index') }}" class="nav-sub-link"><i data-feather="bar-chart-2"></i>Priority Table</a></li>
              <li class="nav-sub-item"><a href="{{ route('task.index') }}" class="nav-sub-link"><i data-feather="bar-chart-2"></i>Task Table</a></li>
            </ul>
          </li>
          <li class="nav-item with-sub">
